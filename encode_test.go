...
func TestValues_omitEmpty(t *testing.T) {
	...
	s := struct {
		a string
		A string
		B string  `q:",omitempty"`
		C string  `q:"-"`
		D string  `q:"omitempty"` // actually named omitempty, not an option
		E *string `q:",omitempty"`
	}{E: &str}
